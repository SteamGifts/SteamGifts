...
public class WhitelistBlacklistAdapter extends EndlessAdapter {
    ...
    private transient WhitelistBlacklistFragment fragment;

    public WhitelistBlacklistAdapter() {
        alternativeEnd = true;
    }

    public void setFragmentValues(WhitelistBlacklistFragment fragment) {
